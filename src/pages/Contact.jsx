    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="space-y-6 max-w-2xl mx-auto">
          ...
          >
            <div className="text-4xl"><img src={`${import.meta.env.BASE_URL}images/logos/outlook.svg`} /></div>
            <div>
          ...
          <a
            ...
            className="flex items-center gap-4 p-6 bg-slate-800 rounded-lg border-2 border-slate-700 hover:border-orange-400 transition"
          >
            <div className="text-4xl"><img src={`${import.meta.env.BASE_URL}images/logos/linkedin.svg`} /></div>
            <div>
